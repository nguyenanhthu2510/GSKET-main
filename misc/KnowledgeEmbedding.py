...
def main(args):
    ...
    model_name_or_path = args.bert_model if hasattr(args, 'bert_model') else 'bert-base-uncased'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--knowledge_file', type=str, default='data/iu/dataset/entity2knowledge_entity2id.json')
    parser.add_argument('--output', type=str, default='data/iu/dataset/knowledge_entity2embedding')
